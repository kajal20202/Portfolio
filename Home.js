...
import portImage from '../components/image/port.jpg'; 
    ...
    <div 
      name="home" className='h-screen w-full bg-gradient-to-b from-black via-black to-gray-800'>
        ...
        <div className='flex flex-col justify-center h-full'>
          <h2 className='text-4xl sm:text-7xl font-bold text-white'>I'm a Intern Software Developer</h2>
          <p className='text-gray-500 py-4 max-w-md'>
            I'm a Intern Software Developer .
      ...
      <div>
        ...
        <img src={portImage} alt="my profile" className="rounded-2xl mx-auto w-2/3 md:w-full" />
